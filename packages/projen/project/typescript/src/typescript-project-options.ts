...
import type { github, GitOptions, IgnoreFileOptions, javascript, LoggerOptions, Project, ProjenrcJsonOptions, release, RenovatebotOptions, SampleReadmeProps, typescript } from './';
