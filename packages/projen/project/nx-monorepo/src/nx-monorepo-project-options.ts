...
import type { github, GitOptions, IgnoreFileOptions, javascript, LoggerOptions, Project, ProjenrcJsonOptions, ReleasableCommits, release, RenovatebotOptions, SampleReadmeProps, typescript } from 'projen';
import type { ProjectNameSchemeOptions } from '@arroyodev-llc/utils.projen';
import type { monorepo } from '@aws/pdk';
...
export interface NxMonorepoProjectOptions {
   ...
   * @stability stable
   */
  readonly workspaceConfig?: monorepo.WorkspaceConfig;
  /**
   ...
   * @stability stable
   */
  readonly monorepoUpgradeDepsOptions?: monorepo.MonorepoUpgradeDepsOptions;
  /**
